              ...
              <div className={'tile is-ancestor'}>
                ...
                <div className={'tile is-parent'}>
                  <div className={'tile-is-child box is-shadowless'}>
                    ...
                    <Image src={'/without-2.png'} width={300} height={300}
                           alt={'PCに向かっているもののうまく行かない様子の女性のイラスト'}/>
            ...
            <div className={'container is-max-widescreen'}>
              ...
              <div className={'box is-shadowless is-size-5 content'}>
                <section className={'section'}>
                  ...
                  <Image
                    src={'https://res.cloudinary.com/hamattimer/image/upload/v1665148260/ljssrxcb2ulsd01zzepc.png'}
                    width={309} height={66} quality={85} alt={'タイマーのスクリーンショット'}/>
                  <p className={'lh-1'}>あらかじめ設定した時間になるとお知らせします。<br/>時間を区切って取り組むことで、詰まってしまった時は人に質問してみるなど次の手を打ちやすくなります。
                  </p>
                  <h4 className={'title is-4 mt-6'}>2. メモ機能</h4>
                  <Image
                    src={'https://res.cloudinary.com/hamattimer/image/upload/v1665148377/sdkppoqnqtk8okr0i08z.png'}
                  ...
                  <Image
                    src={'https://res.cloudinary.com/hamattimer/image/upload/v1665147967/ezhtcnwbyqzth8ct3rip.png'}
